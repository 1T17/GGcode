...
int main(void) {
    ...
    RUN_TEST(test_unknown_token);
    RUN_TEST(test_reserved_word_as_identifier);
    RUN_TEST(test_underscored_identifiers);
    RUN_TEST(test_line_gcode);
    RUN_TEST(test_line_gcode_multi_line);
    RUN_TEST(test_unterminated_multiline_comment);
    RUN_TEST(test_line_and_column_tracking);
    RUN_TEST(test_long_identifier_and_number);
    RUN_TEST(test_invalid_number_formats);
    RUN_TEST(test_long_number_literal);
    RUN_TEST(test_weird_identifiers);
    RUN_TEST(test_unicode_invalid_input);
    RUN_TEST(test_empty_input);
    RUN_TEST(test_only_whitespace);
    RUN_TEST(test_dot_and_dotdot_disambiguation);
